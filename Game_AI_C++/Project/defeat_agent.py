#To execute 
#python -m pysc2.bin.agent --map FindAndDefeatZerglings --agent defeat_agent.Automate  --max_episodes=10 --use_feature_units
...
class Automate(base_agent.BaseAgent):
    scores = []
    size = [5, 75]
    state = 0
    target = [-1, -1]
